			...
			<div class="col-md-10">
				...
				<c:forEach items="${hotProductList }" var="hotPro">
					<div class="col-md-2"
						...
						<a href="product_info.htm"> <img src="${pageContext.request.contextPath }/${hotPro.pimage }"
						...
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${hotPro.market_price }</font>
						</p>
					</div>
				</c:forEach>
			...
			<div class="col-md-10">
				...
				<c:forEach items="${newProductList }" var="newPro">
					<div class="col-md-2"
						...
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${newPro.market_price }</font>
						</p>
					</div>
				</c:forEach>
