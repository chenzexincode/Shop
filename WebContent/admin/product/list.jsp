						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${productList }" var="product" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${product.market_price}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${product.is_hot==0?"否":"是"}</td>
									<td align="center" style="HEIGHT: 22px">
										<a href="${ pageContext.request.contextPath }/adminProduct?method=editProduct&pid=${product.pid}">
