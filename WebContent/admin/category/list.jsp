					...
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<c:forEach items="${categoryList }" var="cate" varStatus="vs">
							...
							<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${cate.cname}</td>
								<td align="center" style="HEIGHT: 22px">
									<a href="${ pageContext.request.contextPath }/adminCategory?method=editCategory&cid=${cate.cid}">
										<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
									</a>
								</td>
								<td align="center" style="HEIGHT: 22px">
									<a href="${ pageContext.request.contextPath }/adminCategory?method=deleteCategory&cid=${cate.cid}">
