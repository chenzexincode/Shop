...
<body>
	...
	<div class="container">
					...
					<tbody>
						...
						<c:forEach items="${order.list }" var="item">
							<tr class="active">
								...
								<td width="20%">￥${item.product.market_price }</td>
		...
		<div>
			<form class="form-horizontal" action="${pageContext.request.contextPath }/order" method="post" id="orderForm" style="margin-top: 5px; margin-left: 150px;">
			...
			<hr />
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="telephont"
							name="telephont" placeholder="请输入联系方式">
					</div>
				</div>
